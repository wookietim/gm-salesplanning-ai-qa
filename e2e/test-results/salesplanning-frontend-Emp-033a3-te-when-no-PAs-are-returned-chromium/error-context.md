...
- Name: salesplanning-frontend.spec.js >> Empty states >> ProductAreaSummaryList shows empty state when no PAs are returned
- Location: salesplanning-frontend.spec.js:1220:5
...
Locator: getByText('No PA entries were returned for this HFB.')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByText('No PA entries were returned for this HFB.')
