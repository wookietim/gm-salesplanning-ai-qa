...
- Generated at: 2026-08-14T15:44:07.923Z
...
- Jira project: SSPLAN
- Jira issue keys: SSPLAN-655
- Extracted criteria:
  - Issue SSPLAN-655: Add Country level filter to Metrics API
  - Acceptance Criteria (derived from description):
  - Add country level filters to metric api for following metrics:
  - RollingSalesTrend
  - SalesIndexToGoal
  - WeeklySalesTrend
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-655: Add Country level filter to Metrics API | BOB-HP-001, BOB-SP-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-001, BOB-SP-001 |
| AC-3 | Add country level filters to metric api for following metrics: | BOB-HP-001, BOB-SP-001 |
| AC-4 | RollingSalesTrend | BOB-HP-001, BOB-SP-001 |
| AC-5 | SalesIndexToGoal | BOB-HP-001, BOB-SP-001 |
| AC-6 | WeeklySalesTrend | BOB-HP-001, BOB-SP-001 |
