...
- Name: salesplanning-frontend.spec.js >> SalesByWeek and SalesIndexTrend error states at HFB and PA level >> SalesIndexTrend shows error on HFB page when /metrics returns 500
- Location: salesplanning-frontend.spec.js:2022:5
...
Locator: getByLabel('Trends - Sales index vs LY')
Expected substring: "Sales trend data is currently unavailable. Please try again later."
Timeout: 20000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 20000ms
  - waiting for getByLabel('Trends - Sales index vs LY')
