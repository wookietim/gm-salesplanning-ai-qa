...
- Name: salesplanning-frontend.spec.js >> PaFamilyListRow MetricRowCell content >> PA rows show numeric values alongside the metric labels
- Location: salesplanning-frontend.spec.js:2141:5
