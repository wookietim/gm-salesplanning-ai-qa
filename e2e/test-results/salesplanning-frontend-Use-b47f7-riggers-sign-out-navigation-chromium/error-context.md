...
- Name: salesplanning-frontend.spec.js >> User component (header avatar & flyout modal) >> "Sign out" button is present in the modal and triggers sign-out navigation
- Location: salesplanning-frontend.spec.js:1031:5
