...
- Name: salesplanning-frontend.spec.js >> SalesIndexTrend chart >> shows loading state while trend data is fetching
- Location: salesplanning-frontend.spec.js:1081:5
