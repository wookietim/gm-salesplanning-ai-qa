...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-701 & SSPLAN-692 — KpiSummaryCard metric labels >> KpiSummaryCard shows all four metric row cell labels on the HFB dashboard
- Location: salesplanning-frontend.spec.js:1489:9
...
"
    - waiting for "https://dev.salesplanning.ingka.com/region-dashboard/se/hfb/01" navigation to finish...
    - navigated to "https://dev.salesplanning.ingka.com/region-dashboard/se/hfb/01"
    10 × locator resolved to <body>429 Too Many Requests</body>
