...
- Name: salesplanning-frontend.spec.js >> Edge cases >> GapToClose component >> KpiSummaryCard shows "Gap to close:" label with formatted quantity and sales gap
- Location: salesplanning-frontend.spec.js:1652:9
