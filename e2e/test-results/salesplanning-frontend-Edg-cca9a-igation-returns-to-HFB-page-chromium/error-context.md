...
- Name: salesplanning-frontend.spec.js >> Edge cases >> Browser back/forward navigation >> browser back after HFB→PA navigation returns to HFB page
- Location: salesplanning-frontend.spec.js:1815:9
...
Call log:
  - waiting for getByRole('button', { name: /Sofas.*001/ })
