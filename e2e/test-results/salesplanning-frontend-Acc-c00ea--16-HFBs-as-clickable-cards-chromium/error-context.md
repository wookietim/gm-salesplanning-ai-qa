...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-637 — HFB list page >> HFB list renders all 16 HFBs as clickable cards
- Location: salesplanning-frontend.spec.js:1245:9
