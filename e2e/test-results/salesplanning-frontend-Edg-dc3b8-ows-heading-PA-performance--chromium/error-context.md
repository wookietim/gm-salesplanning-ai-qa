...
- Name: salesplanning-frontend.spec.js >> Edge cases >> ProductAreaSummaryList subtitle >> PA list section shows heading "PA performance"
- Location: salesplanning-frontend.spec.js:1696:9
...
Locator: getByLabel('PA list navigation').getByRole('heading', { level: 2 })
Expected substring: "PA performance"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByLabel('PA list navigation').getByRole('heading', { level: 2 })
