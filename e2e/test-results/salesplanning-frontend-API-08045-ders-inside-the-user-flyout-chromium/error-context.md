...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Graph user profile fields render in the user flyout >> email (mail) from Graph API renders inside the user flyout
- Location: salesplanning-frontend.spec.js:2268:9
