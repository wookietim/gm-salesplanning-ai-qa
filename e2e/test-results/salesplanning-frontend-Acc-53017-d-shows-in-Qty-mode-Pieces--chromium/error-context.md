...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-623 — SalesByWeek legend conditional rendering >> "actual sales" legend shows in Qty mode (Pieces)
- Location: salesplanning-frontend.spec.js:1362:9
