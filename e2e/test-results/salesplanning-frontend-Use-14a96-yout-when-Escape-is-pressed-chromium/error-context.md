...
- Name: salesplanning-frontend.spec.js >> User component (header avatar & flyout modal) >> closes the flyout when Escape is pressed
- Location: salesplanning-frontend.spec.js:1024:5
