...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-623 — SalesByWeek legend conditional rendering >> "actual sales" legend is HIDDEN in Qty index mode (not a Pieces view)
- Location: salesplanning-frontend.spec.js:1374:9
