...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB card → HFB page (click-based) >> clicking the HFB 10 card navigates to the HFB 10 page
- Location: salesplanning-frontend.spec.js:787:9
