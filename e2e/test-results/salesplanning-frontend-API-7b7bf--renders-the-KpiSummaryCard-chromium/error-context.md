...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Different API responses per region produce different UI output >> XX region (nonexistent) still gets the mock API data and renders the KpiSummaryCard
- Location: salesplanning-frontend.spec.js:2535:9
