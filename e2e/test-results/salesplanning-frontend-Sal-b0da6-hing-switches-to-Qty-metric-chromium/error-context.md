...
- Name: salesplanning-frontend.spec.js >> SalesByWeek SegmentControl (metric type switching) >> switches to Qty metric
- Location: salesplanning-frontend.spec.js:1110:5
