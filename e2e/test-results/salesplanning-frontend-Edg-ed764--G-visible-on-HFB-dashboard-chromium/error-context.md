...
- Name: salesplanning-frontend.spec.js >> Edge cases >> "· Forecast G" appears on all dashboard levels >> "· Forecast G" visible on HFB dashboard
- Location: salesplanning-frontend.spec.js:1640:9
