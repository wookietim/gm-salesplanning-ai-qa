...
- Name: salesplanning-frontend.spec.js >> Header and breadcrumb navigation >> "Sales Planning" header link navigates home from the region dashboard
- Location: salesplanning-frontend.spec.js:729:5
