...
- Name: salesplanning-frontend.spec.js >> NewsInHfbList component (HFB dashboard) >> shows all four SegmentControl metric options and defaults to Qty index
- Location: salesplanning-frontend.spec.js:1180:5
...
Locator: getByLabel('News in HFB list').getByRole('button', { name: 'Qty index' })
Expected: "true"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('News in HFB list').getByRole('button', { name: 'Qty index' })
