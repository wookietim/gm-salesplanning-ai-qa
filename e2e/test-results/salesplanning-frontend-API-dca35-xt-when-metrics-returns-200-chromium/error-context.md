...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Rolling trend API data → SalesIndexTrend section >> SalesIndexTrend does NOT show error text when /metrics returns 200
- Location: salesplanning-frontend.spec.js:2425:9
