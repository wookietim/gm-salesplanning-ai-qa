...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-691 — Segmented Control on all levels >> SegmentControl with all 4 options appears in SalesByWeek on the PA dashboard
- Location: salesplanning-frontend.spec.js:1302:9
