...
- Name: salesplanning-frontend.spec.js >> ProductAreaSummaryList SegmentControl (metric type switching) >> switches to Qty metric
- Location: salesplanning-frontend.spec.js:1154:5
...
Call log:
  - waiting for getByLabel('PA list navigation').getByRole('button', { name: 'Qty', exact: true })
