...
- Name: salesplanning-frontend.spec.js >> HeroMetric component >> shows the rounded index value (94) in the country-level KpiSummaryCard
- Location: salesplanning-frontend.spec.js:1887:5
