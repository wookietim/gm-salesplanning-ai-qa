...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-628 — Personalized greeting >> Greeting is replaced by breadcrumbs (not welcome text) on HFB level
- Location: salesplanning-frontend.spec.js:1267:9
