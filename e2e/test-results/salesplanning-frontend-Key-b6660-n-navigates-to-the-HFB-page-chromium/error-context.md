...
- Name: salesplanning-frontend.spec.js >> Keyboard navigation >> Enter key on a focused "View HFB plan" button navigates to the HFB page
- Location: salesplanning-frontend.spec.js:2082:5
