...
- Name: salesplanning-frontend.spec.js >> Edge cases >> GapToClose component >> "Gap to close:" visible on PA dashboard KpiSummaryCard
- Location: salesplanning-frontend.spec.js:1663:9
