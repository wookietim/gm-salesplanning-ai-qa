...
- Name: salesplanning-frontend.spec.js >> IkeaCurrentWeek component >> renders the current IKEA week number in the NavigationBar
- Location: salesplanning-frontend.spec.js:1045:5
