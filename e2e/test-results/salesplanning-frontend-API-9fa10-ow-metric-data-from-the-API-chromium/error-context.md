...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Different API responses per region produce different UI output >> SE and US KpiSummaryCards both show metric data from the API
- Location: salesplanning-frontend.spec.js:2525:9
