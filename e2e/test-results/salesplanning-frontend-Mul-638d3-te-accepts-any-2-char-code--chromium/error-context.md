...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> XX — nonexistent region (valid 2-char code, no real data) >> renders XX country dashboard with h1 = XX Sales (route accepts any 2-char code)
- Location: salesplanning-frontend.spec.js:1557:9
