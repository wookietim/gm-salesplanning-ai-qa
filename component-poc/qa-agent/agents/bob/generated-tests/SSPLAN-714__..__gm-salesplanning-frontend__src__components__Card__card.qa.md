# Bob QA Test Plan - Card

- Generated at: 2026-08-14T13:50:58.703Z
- Source component: ../gm-salesplanning-frontend/src/components/Card/card.tsx
...
- Jira project: SSPLAN
- Jira issue keys: SSPLAN-714
- Extracted criteria:
  - Issue SSPLAN-714: Create Blank Card Component
  - Acceptance Criteria (derived from description):
  - Create blank card component to be used for card modules within the sales planning tool.
  - [Figma Link to Component|https://www.figma.com/design/HdtKcUKqPyPfxr3Er8sStc/Sales-Planning---Spec?node-id=3280-12820&t=9kAvJIGvNgWFCQf4-4]
  - [Figma link to no content view|https://www.figma.com/design/HdtKcUKqPyPfxr3Er8sStc/Sales-Planning---Spec?node-id=3280-14601&amp;t=EEyDWqUBSD2vth34-0]
...
- Title: Card renders and completes primary user flow successfully
- Priority: High
- Preconditions:
...
- Steps:
1. Open the page or parent container where Card is rendered.
...
- Title: Card handles invalid or missing data and dependency failures
- Priority: High
- Preconditions:
...
- Steps:
1. Render Card with incomplete or invalid input data.
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-714: Create Blank Card Component | BOB-HP-001, BOB-SP-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-001, BOB-SP-001 |
| AC-3 | Create blank card component to be used for card modules within the sales planning tool. | BOB-HP-001, BOB-SP-001 |
| AC-4 | [Figma Link to Component\|https://www.figma.com/design/HdtKcUKqPyPfxr3Er8sStc/Sales-Planning---Spec?node-id=3280-12820&t=9kAvJIGvNgWFCQf4-4] | BOB-HP-001, BOB-SP-001 |
| AC-5 | [Figma link to no content view\|https://www.figma.com/design/HdtKcUKqPyPfxr3Er8sStc/Sales-Planning---Spec?node-id=3280-14601&amp;t=EEyDWqUBSD2vth34-0] | BOB-HP-001, BOB-SP-001 |
