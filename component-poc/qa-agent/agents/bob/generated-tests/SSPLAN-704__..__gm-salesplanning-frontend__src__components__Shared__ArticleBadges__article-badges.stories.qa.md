# Bob QA Test Plan - NewLowerPrice

- Generated at: 2026-08-17T18:22:18.703Z
- Source component: ../gm-salesplanning-frontend/src/components/Shared/ArticleBadges/article-badges.stories.tsx

## 1. Component Overview

- Component: NewLowerPrice
...
### Test ID: BOB-HP-NEWLOW-001

- Title: NewLowerPrice renders baseline view with valid defaults
- Priority: High
- Preconditions:
...
- Steps:
1. Open the screen where NewLowerPrice is rendered with baseline valid data.
...
### Test ID: BOB-HP-NEWLOW-002

- Title: NewLowerPrice supports primary interaction updates
- Priority: High
- Preconditions:
...
### Test ID: BOB-SP-NEWLOW-001

- Title: NewLowerPrice handles invalid or incomplete input safely
- Priority: High
- Preconditions:
...
- Steps:
1. Render NewLowerPrice with incomplete or invalid values.
...
### Test ID: BOB-SP-NEWLOW-002

- Title: NewLowerPrice preserves consistency across linked fields
- Priority: Medium
- Preconditions:
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-704: [FE] Add storybook publishing on each PR | BOB-HP-NEWLOW-001, BOB-HP-NEWLOW-002, BOB-SP-NEWLOW-001, BOB-SP-NEWLOW-002, BOB-A11Y-NEWLOW-001, BOB-ASYNC-NEWLOW-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-NEWLOW-001, BOB-HP-NEWLOW-002, BOB-SP-NEWLOW-001, BOB-SP-NEWLOW-002, BOB-A11Y-NEWLOW-001, BOB-ASYNC-NEWLOW-001 |
| AC-3 | We need a way to see new components implementation and storybook can help with that but we need to have a preview published on each PR open | BOB-HP-NEWLOW-001, BOB-HP-NEWLOW-002, BOB-SP-NEWLOW-001, BOB-SP-NEWLOW-002, BOB-A11Y-NEWLOW-001, BOB-ASYNC-NEWLOW-001 |
