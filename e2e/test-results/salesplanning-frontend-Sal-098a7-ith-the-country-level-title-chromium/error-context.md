...
- Name: salesplanning-frontend.spec.js >> SalesIndexTrend chart >> renders on the region dashboard with the country-level title
- Location: salesplanning-frontend.spec.js:1063:5
