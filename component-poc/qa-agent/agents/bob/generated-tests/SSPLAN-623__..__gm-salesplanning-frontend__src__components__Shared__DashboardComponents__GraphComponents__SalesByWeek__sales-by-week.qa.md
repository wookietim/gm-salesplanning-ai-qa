...
- Generated at: 2026-08-10T18:59:33.343Z
...
- Jira project: SSPLAN
- Jira issue keys: SSPLAN-623
- Extracted criteria:
  - Derive acceptance criteria from Jira issues: SSPLAN-623.
...
- Title: SalesByWeek renders and completes primary user flow successfully
- Priority: High
- Preconditions:
...
- Steps:
1. Open the page or parent container where SalesByWeek is rendered.
...
- Title: SalesByWeek handles invalid or missing data and dependency failures
- Priority: High
- Preconditions:
...
- Steps:
1. Render SalesByWeek with incomplete or invalid input data.
...
| --- | --- | --- |
| AC-1 | Derive acceptance criteria from Jira issues: SSPLAN-623. | BOB-HP-001, BOB-SP-001 |
