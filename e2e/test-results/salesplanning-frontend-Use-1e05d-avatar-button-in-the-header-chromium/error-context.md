...
- Name: salesplanning-frontend.spec.js >> User component (header avatar & flyout modal) >> renders the user avatar button in the header
- Location: salesplanning-frontend.spec.js:1011:5
