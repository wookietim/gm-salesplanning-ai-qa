...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> Multi-hop journeys >> Region → HFB 01 (click) → back → HFB 02 (click) → back → Region
- Location: salesplanning-frontend.spec.js:891:9
