...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB card → HFB page (click-based) >> clicking the HFB 02 card navigates to the HFB 02 page
- Location: salesplanning-frontend.spec.js:775:9
