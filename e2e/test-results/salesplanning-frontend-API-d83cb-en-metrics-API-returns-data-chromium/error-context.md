...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Weekly metrics API data → Sales by week chart >> SalesByWeek section renders on the PA page when metrics API returns data
- Location: salesplanning-frontend.spec.js:2368:9
