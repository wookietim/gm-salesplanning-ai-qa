...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Weekly metrics API data → Sales by week chart >> SalesByWeek does NOT show the error message when /metrics returns 200
- Location: salesplanning-frontend.spec.js:2374:9
...
Expected substring: not "Sales trend data is currently unavailable. Please try again later."
Timeout: 5000ms
