...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-691 — Segmented Control on all levels >> SegmentControl with all 4 options appears in SalesByWeek on the HFB dashboard
- Location: salesplanning-frontend.spec.js:1294:9
