...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Hierarchy API data → PA list rows >> clicking a PA row navigates to the URL built from the hierarchy paNo
- Location: salesplanning-frontend.spec.js:2318:9
...
Call log:
  - waiting for getByRole('button', { name: /UniquePA003/ })
