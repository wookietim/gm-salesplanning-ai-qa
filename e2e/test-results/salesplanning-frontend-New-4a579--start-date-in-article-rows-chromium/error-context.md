...
- Name: salesplanning-frontend.spec.js >> NewsArticle sub-components >> SalesStatusRow shows "Sales start date:" in article rows
- Location: salesplanning-frontend.spec.js:1936:5
