...
- Name: salesplanning-frontend.spec.js >> PA dashboard (/region-dashboard/se/hfb/01/pa/001) >> renders PA-level sales graphs (no PA list)
- Location: salesplanning-frontend.spec.js:706:5
