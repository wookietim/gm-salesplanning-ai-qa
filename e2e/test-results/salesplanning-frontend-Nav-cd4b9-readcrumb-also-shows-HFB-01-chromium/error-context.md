...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB page → PA page (click-based) >> PA 001 breadcrumb shows HFB 01, PA 002 breadcrumb also shows HFB 01
- Location: salesplanning-frontend.spec.js:839:9
