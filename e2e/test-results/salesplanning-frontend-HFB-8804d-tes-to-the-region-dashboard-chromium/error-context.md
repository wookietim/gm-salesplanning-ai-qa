...
- Name: salesplanning-frontend.spec.js >> HFB dashboard (/region-dashboard/se/hfb/01) >> back button navigates to the region dashboard
- Location: salesplanning-frontend.spec.js:639:5
...
Call log:
  - waiting for getByRole('button', { name: 'Go back' })
...
```yaml
- generic [active] [ref=f1e1]: 429 Too Many Requests
```
