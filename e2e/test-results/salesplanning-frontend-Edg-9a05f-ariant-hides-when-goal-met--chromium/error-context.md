...
- Name: salesplanning-frontend.spec.js >> Edge cases >> GapToClose component >> "Gap to close:" is NOT shown when quantityGap >= 0 (large variant hides when goal met)
- Location: salesplanning-frontend.spec.js:1678:9
...
Expected substring: "Gap to close:"
