...
- Name: salesplanning-frontend.spec.js >> NewsInHfbList component (HFB dashboard) >> switches metric type via SegmentControl and list remains visible
- Location: salesplanning-frontend.spec.js:1188:5
...
Call log:
  - waiting for getByLabel('News in HFB list').getByRole('button', { name: 'Sales index' })
