...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Rolling trend API data → SalesIndexTrend section >> SalesIndexTrend section is visible on the HFB dashboard when rolling trend API returns data
- Location: salesplanning-frontend.spec.js:2415:9
...
Locator: getByRole('region', { name: /Trends - Sales index vs LY/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('region', { name: /Trends - Sales index vs LY/ })
