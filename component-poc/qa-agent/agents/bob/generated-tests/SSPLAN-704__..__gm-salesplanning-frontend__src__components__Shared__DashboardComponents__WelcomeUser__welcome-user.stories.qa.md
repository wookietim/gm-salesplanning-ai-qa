# Bob QA Test Plan - WithGivenName

- Generated at: 2026-08-12T18:25:37.531Z
- Source component: ../gm-salesplanning-frontend/src/components/Shared/DashboardComponents/WelcomeUser/welcome-user.stories.tsx

## 1. Component Overview

- Component: WithGivenName
...
- Title: WithGivenName renders and completes primary user flow successfully
- Priority: High
- Preconditions:
...
- Runtime assertion: async-success-observed
- Steps:
1. Open the page or parent container where WithGivenName is rendered.
...
- Title: WithGivenName handles invalid or missing data and dependency failures
- Priority: High
- Preconditions:
...
- Steps:
1. Render WithGivenName with incomplete or invalid input data.
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-704: [FE] Add storybook publishing on each PR | BOB-HP-001, BOB-SP-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-001, BOB-SP-001 |
| AC-3 | We need a way to see new components implementation and storybook can help with that but we need to have a preview published on each PR open | BOB-HP-001, BOB-SP-001 |
