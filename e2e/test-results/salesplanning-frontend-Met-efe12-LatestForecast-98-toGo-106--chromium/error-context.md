...
- Name: salesplanning-frontend.spec.js >> MetricRowCell numeric values >> country KpiSummaryCard shows specific numeric metric values (vsLatestForecast=98, toGo=106)
- Location: salesplanning-frontend.spec.js:1902:5
