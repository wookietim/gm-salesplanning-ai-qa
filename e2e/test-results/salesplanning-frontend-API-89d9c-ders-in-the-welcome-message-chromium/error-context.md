...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Graph user profile fields render in the user flyout >> displayName from Graph API (Test User) renders in the welcome message
- Location: salesplanning-frontend.spec.js:2248:9
...
Locator: getByText('Hej, Test User')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Hej, Test User')
