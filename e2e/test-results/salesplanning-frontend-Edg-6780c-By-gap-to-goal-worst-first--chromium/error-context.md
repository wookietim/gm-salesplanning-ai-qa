...
- Name: salesplanning-frontend.spec.js >> Edge cases >> ProductAreaSummaryList subtitle >> PA list section shows subtitle "By gap to goal (worst first)"
- Location: salesplanning-frontend.spec.js:1688:9
...
Locator: getByLabel('PA list navigation')
Expected substring: "By gap to goal (worst first)"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByLabel('PA list navigation')
