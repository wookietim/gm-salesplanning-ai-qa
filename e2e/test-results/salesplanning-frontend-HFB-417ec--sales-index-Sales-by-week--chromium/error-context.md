...
- Name: salesplanning-frontend.spec.js >> HFB dashboard (/region-dashboard/se/hfb/01) >> renders HFB-level sales graphs (YTD sales index, Sales by week)
- Location: salesplanning-frontend.spec.js:658:5
...
Locator: getByText('YTD sales index')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('YTD sales index')
