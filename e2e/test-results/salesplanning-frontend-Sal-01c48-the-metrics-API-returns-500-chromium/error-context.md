...
- Name: salesplanning-frontend.spec.js >> SalesIndexTrend chart >> shows error message when the metrics API returns 500
- Location: salesplanning-frontend.spec.js:1088:5
