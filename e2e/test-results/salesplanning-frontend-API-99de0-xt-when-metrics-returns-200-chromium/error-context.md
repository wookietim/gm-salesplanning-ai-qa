...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Rolling trend API data → SalesIndexTrend section >> SalesIndexTrend on HFB page does NOT show error text when /metrics returns 200
- Location: salesplanning-frontend.spec.js:2430:9
