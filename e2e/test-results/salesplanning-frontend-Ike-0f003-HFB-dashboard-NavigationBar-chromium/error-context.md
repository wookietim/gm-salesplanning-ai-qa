...
- Name: salesplanning-frontend.spec.js >> IkeaCurrentWeek component >> IKEA week is also visible on the HFB dashboard NavigationBar
- Location: salesplanning-frontend.spec.js:1051:5
