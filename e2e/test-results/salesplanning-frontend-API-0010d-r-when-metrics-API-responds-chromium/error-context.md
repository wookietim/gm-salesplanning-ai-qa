...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Different API responses per region produce different UI output >> SE and US pages both render without error when metrics API responds
- Location: salesplanning-frontend.spec.js:2515:9
