...
- Name: salesplanning-frontend.spec.js >> SalesByWeek h3 title on all dashboard levels >> "Sales by week" h3 heading renders on the country dashboard
- Location: salesplanning-frontend.spec.js:1976:5
...
Locator: getByLabel('Sales by week').getByRole('heading', { level: 3 })
Expected substring: "Sales by week"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByLabel('Sales by week').getByRole('heading', { level: 3 })
