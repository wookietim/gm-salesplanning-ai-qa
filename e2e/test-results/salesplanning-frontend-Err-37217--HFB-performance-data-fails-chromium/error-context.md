...
- Name: salesplanning-frontend.spec.js >> Error states >> HfbList shows error message when HFB performance data fails
- Location: salesplanning-frontend.spec.js:963:5
...
Locator: getByText('HFB performance data is currently unavailable. Please try again later.')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByText('HFB performance data is currently unavailable. Please try again later.')
