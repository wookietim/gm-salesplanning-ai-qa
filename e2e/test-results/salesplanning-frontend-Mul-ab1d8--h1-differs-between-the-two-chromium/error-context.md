...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> US region (/region-dashboard/us/) >> US and SE dashboards are independent — h1 differs between the two
- Location: salesplanning-frontend.spec.js:1545:9
