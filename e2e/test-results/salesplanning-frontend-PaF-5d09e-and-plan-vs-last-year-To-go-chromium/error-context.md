...
- Name: salesplanning-frontend.spec.js >> PaFamilyListRow MetricRowCell content >> PA rows show all four MetricRowCell labels: vs goal, vs demand plan, vs last year, To-go
- Location: salesplanning-frontend.spec.js:2134:5
