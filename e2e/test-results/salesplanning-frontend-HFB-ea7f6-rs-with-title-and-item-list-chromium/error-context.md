...
- Name: salesplanning-frontend.spec.js >> HFB dashboard (/region-dashboard/se/hfb/01) >> NewsInHfbList section renders with title and item list
- Location: salesplanning-frontend.spec.js:664:5
