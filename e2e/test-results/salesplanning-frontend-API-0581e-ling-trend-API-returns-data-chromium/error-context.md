...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Rolling trend API data → SalesIndexTrend section >> SalesIndexTrend section is visible on the country dashboard when rolling trend API returns data
- Location: salesplanning-frontend.spec.js:2410:9
