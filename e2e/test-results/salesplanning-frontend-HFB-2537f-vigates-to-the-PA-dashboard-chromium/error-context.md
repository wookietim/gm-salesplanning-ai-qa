...
- Name: salesplanning-frontend.spec.js >> HFB dashboard (/region-dashboard/se/hfb/01) >> clicking a PA row navigates to the PA dashboard
- Location: salesplanning-frontend.spec.js:652:5
