...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> Multi-hop journeys >> Full breadcrumb round-trip: Region → HFB 01 → PA 001 → breadcrumb HFB 01 → breadcrumb SE → Region
- Location: salesplanning-frontend.spec.js:928:9
...
Call log:
  - waiting for getByLabel('Breadcrumb').getByRole('link', { name: 'HFB 01' })
