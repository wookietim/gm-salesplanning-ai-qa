...
- Name: salesplanning-frontend.spec.js >> SalesByWeek SegmentControl (metric type switching) >> defaults to Sales and shows all four metric options
- Location: salesplanning-frontend.spec.js:1102:5
...
Locator: getByLabel('Sales by week').getByRole('button', { name: 'Sales', exact: true })
Expected: "true"
Timeout: 5000ms
