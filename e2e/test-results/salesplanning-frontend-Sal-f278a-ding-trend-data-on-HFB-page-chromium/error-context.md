...
- Name: salesplanning-frontend.spec.js >> SalesIndexTrend loading state at HFB and PA level >> SalesIndexTrend shows Loading trend data... on HFB page
- Location: salesplanning-frontend.spec.js:1996:5
...
Locator: getByLabel('Trends - Sales index vs LY').getByRole('status')
Expected substring: "Loading trend data..."
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for getByLabel('Trends - Sales index vs LY').getByRole('status')
