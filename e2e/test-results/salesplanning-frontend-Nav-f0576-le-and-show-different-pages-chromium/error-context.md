...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB page → PA page (click-based) >> PA 001 and PA 002 are independently navigable and show different pages
- Location: salesplanning-frontend.spec.js:827:9
