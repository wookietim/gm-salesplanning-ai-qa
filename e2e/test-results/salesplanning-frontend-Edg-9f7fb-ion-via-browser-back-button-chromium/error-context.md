...
- Name: salesplanning-frontend.spec.js >> Edge cases >> Browser back/forward navigation >> three-level back: PA → HFB → Region via browser back button
- Location: salesplanning-frontend.spec.js:1827:9
