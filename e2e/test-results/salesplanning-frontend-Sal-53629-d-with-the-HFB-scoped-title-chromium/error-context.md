...
- Name: salesplanning-frontend.spec.js >> SalesIndexTrend chart >> renders on the HFB dashboard with the HFB-scoped title
- Location: salesplanning-frontend.spec.js:1069:5
