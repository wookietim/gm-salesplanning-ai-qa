...
- Name: salesplanning-frontend.spec.js >> Edge cases >> SalesByWeek loading state on HFB and PA pages >> SalesByWeek shows Loading trend data... while metrics are fetching on PA page
- Location: salesplanning-frontend.spec.js:1778:9
