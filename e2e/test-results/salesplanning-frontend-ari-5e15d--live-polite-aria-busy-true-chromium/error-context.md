...
- Name: salesplanning-frontend.spec.js >> aria-live and aria-busy attributes on loading spinners >> HFB list loading div: aria-live=polite, aria-busy=true
- Location: salesplanning-frontend.spec.js:2038:5
...
Locator: getByLabel('HFB list navigation').getByRole('status')
Expected: "polite"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('HFB list navigation').getByRole('status')
