...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-701 & SSPLAN-692 — KpiSummaryCard metric labels >> Each HFB card in the HFB list shows its own KpiSummaryCard title
- Location: salesplanning-frontend.spec.js:1496:9
