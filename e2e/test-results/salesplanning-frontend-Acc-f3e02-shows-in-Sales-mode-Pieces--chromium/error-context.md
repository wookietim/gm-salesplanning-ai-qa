...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-623 — SalesByWeek legend conditional rendering >> "actual sales" legend shows in Sales mode (Pieces)
- Location: salesplanning-frontend.spec.js:1356:9
