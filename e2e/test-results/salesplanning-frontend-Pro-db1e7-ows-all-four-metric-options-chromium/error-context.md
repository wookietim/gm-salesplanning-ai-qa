...
- Name: salesplanning-frontend.spec.js >> ProductAreaSummaryList SegmentControl (metric type switching) >> defaults to Qty index and shows all four metric options
- Location: salesplanning-frontend.spec.js:1138:5
...
Locator: getByLabel('PA list navigation').getByRole('button', { name: 'Qty index' })
Expected: "true"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('PA list navigation').getByRole('button', { name: 'Qty index' })
