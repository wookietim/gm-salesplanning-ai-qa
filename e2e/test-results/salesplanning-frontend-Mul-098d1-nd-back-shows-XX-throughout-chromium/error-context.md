...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> XX — nonexistent region (valid 2-char code, no real data) >> navigating from XX dashboard to HFB and back shows XX throughout
- Location: salesplanning-frontend.spec.js:1574:9
