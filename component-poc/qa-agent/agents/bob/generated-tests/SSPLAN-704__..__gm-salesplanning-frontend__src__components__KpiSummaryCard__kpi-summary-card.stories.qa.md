# Bob QA Test Plan - Large

- Generated at: 2026-08-17T18:22:18.703Z
- Source component: ../gm-salesplanning-frontend/src/components/KpiSummaryCard/kpi-summary-card.stories.tsx
...
### Test ID: BOB-HP-LARGE-001

- Title: Large renders baseline view with valid defaults
- Priority: High
- Preconditions:
...
- Steps:
1. Open the screen where Large is rendered with baseline valid data.
...
### Test ID: BOB-HP-LARGE-002

- Title: Large supports primary interaction updates
- Priority: High
- Preconditions:
...
### Test ID: BOB-SP-LARGE-001

- Title: Large handles invalid or incomplete input safely
- Priority: High
- Preconditions:
...
- Steps:
1. Render Large with incomplete or invalid values.
...
### Test ID: BOB-SP-LARGE-002

- Title: Large preserves consistency across linked fields
- Priority: Medium
- Preconditions:
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-704: [FE] Add storybook publishing on each PR | BOB-HP-LARGE-001, BOB-HP-LARGE-002, BOB-SP-LARGE-001, BOB-SP-LARGE-002, BOB-A11Y-LARGE-001, BOB-ASYNC-LARGE-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-LARGE-001, BOB-HP-LARGE-002, BOB-SP-LARGE-001, BOB-SP-LARGE-002, BOB-A11Y-LARGE-001, BOB-ASYNC-LARGE-001 |
| AC-3 | We need a way to see new components implementation and storybook can help with that but we need to have a preview published on each PR open | BOB-HP-LARGE-001, BOB-HP-LARGE-002, BOB-SP-LARGE-001, BOB-SP-LARGE-002, BOB-A11Y-LARGE-001, BOB-ASYNC-LARGE-001 |
