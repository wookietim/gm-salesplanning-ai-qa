...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> US region (/region-dashboard/us/) >> renders US country dashboard with h1 = US Sales
- Location: salesplanning-frontend.spec.js:1521:9
