...
- Name: salesplanning-frontend.spec.js >> HFB dashboard (/region-dashboard/se/hfb/01) >> NewsInHfbList shows loading state while item range data is fetching
- Location: salesplanning-frontend.spec.js:672:5
...
Expected substring: "Loading item range..."
Timeout: 5000ms
