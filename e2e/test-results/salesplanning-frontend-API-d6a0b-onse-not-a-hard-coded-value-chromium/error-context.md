...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Hierarchy API data → PA list rows >> PA page heading uses the paNo from the hierarchy response, not a hard-coded value
- Location: salesplanning-frontend.spec.js:2325:9
