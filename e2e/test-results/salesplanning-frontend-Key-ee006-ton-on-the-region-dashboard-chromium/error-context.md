...
- Name: salesplanning-frontend.spec.js >> Keyboard navigation >> Tab key can reach a "View HFB plan" button on the region dashboard
- Location: salesplanning-frontend.spec.js:2074:5
