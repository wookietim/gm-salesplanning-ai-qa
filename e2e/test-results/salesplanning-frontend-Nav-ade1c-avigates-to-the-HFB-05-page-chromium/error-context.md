...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB card → HFB page (click-based) >> clicking the HFB 05 card navigates to the HFB 05 page
- Location: salesplanning-frontend.spec.js:781:9
