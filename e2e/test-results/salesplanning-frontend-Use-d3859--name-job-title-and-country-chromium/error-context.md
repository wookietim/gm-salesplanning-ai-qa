...
- Name: salesplanning-frontend.spec.js >> User component (header avatar & flyout modal) >> opens the flyout modal showing the user display name, job title and country
- Location: salesplanning-frontend.spec.js:1015:5
