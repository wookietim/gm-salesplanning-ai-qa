...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> Region URL case-insensitivity >> /region-dashboard/US/ (uppercase) normalises to lowercase and renders US Sales
- Location: salesplanning-frontend.spec.js:1593:9
