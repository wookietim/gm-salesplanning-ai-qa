...
- Name: salesplanning-frontend.spec.js >> PA dashboard (/region-dashboard/se/hfb/01/pa/001) >> back button navigates to the HFB dashboard
- Location: salesplanning-frontend.spec.js:700:5
