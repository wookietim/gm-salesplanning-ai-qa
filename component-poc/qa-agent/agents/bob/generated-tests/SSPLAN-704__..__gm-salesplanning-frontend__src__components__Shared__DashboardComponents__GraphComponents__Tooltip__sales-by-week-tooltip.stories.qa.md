# Bob QA Test Plan - MagnitudeMetric

- Generated at: 2026-08-17T18:22:18.703Z
- Source component: ../gm-salesplanning-frontend/src/components/Shared/DashboardComponents/GraphComponents/Tooltip/sales-by-week-tooltip.stories.tsx

## 1. Component Overview

- Component: MagnitudeMetric
...
### Test ID: BOB-HP-MAGNIT-001

- Title: MagnitudeMetric renders baseline view with valid defaults
- Priority: High
- Preconditions:
...
- Steps:
1. Open the screen where MagnitudeMetric is rendered with baseline valid data.
...
### Test ID: BOB-HP-MAGNIT-002

- Title: MagnitudeMetric supports primary interaction updates
- Priority: High
- Preconditions:
...
### Test ID: BOB-SP-MAGNIT-001

- Title: MagnitudeMetric handles invalid or incomplete input safely
- Priority: High
- Preconditions:
...
- Steps:
1. Render MagnitudeMetric with incomplete or invalid values.
...
### Test ID: BOB-SP-MAGNIT-002

- Title: MagnitudeMetric preserves consistency across linked fields
- Priority: Medium
- Preconditions:
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-704: [FE] Add storybook publishing on each PR | BOB-HP-MAGNIT-001, BOB-HP-MAGNIT-002, BOB-SP-MAGNIT-001, BOB-SP-MAGNIT-002, BOB-A11Y-MAGNIT-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-MAGNIT-001, BOB-HP-MAGNIT-002, BOB-SP-MAGNIT-001, BOB-SP-MAGNIT-002, BOB-A11Y-MAGNIT-001 |
| AC-3 | We need a way to see new components implementation and storybook can help with that but we need to have a preview published on each PR open | BOB-HP-MAGNIT-001, BOB-HP-MAGNIT-002, BOB-SP-MAGNIT-001, BOB-SP-MAGNIT-002, BOB-A11Y-MAGNIT-001 |
