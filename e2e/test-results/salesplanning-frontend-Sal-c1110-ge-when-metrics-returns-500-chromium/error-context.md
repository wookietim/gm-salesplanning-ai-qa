...
- Name: salesplanning-frontend.spec.js >> SalesByWeek and SalesIndexTrend error states at HFB and PA level >> SalesByWeek shows error on HFB page when /metrics returns 500
- Location: salesplanning-frontend.spec.js:2012:5
