...
- Name: salesplanning-frontend.spec.js >> ProductAreaSummaryList SegmentControl (metric type switching) >> switches to Sales metric
- Location: salesplanning-frontend.spec.js:1160:5
...
Call log:
  - waiting for getByLabel('PA list navigation').getByRole('button', { name: 'Sales', exact: true })
