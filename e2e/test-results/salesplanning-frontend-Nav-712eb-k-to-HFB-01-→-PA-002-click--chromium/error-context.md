...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> Multi-hop journeys >> Region → HFB 01 (click) → PA 001 (click) → back to HFB 01 → PA 002 (click)
- Location: salesplanning-frontend.spec.js:909:9
