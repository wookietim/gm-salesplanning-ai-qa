...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-637 — HFB list page >> HFB list section subtitle reads "By gap to goal (worst first)"
- Location: salesplanning-frontend.spec.js:1241:9
