...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Graph user profile fields render in the user flyout >> jobTitle from Graph API renders inside the user flyout
- Location: salesplanning-frontend.spec.js:2261:9
