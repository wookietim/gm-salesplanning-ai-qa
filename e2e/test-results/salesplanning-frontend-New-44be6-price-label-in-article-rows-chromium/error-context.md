...
- Name: salesplanning-frontend.spec.js >> NewsArticle sub-components >> ChecksRow shows "Has price" label in article rows
- Location: salesplanning-frontend.spec.js:1932:5
