...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB card → HFB page (click-based) >> clicking the HFB 01 card navigates to the HFB 01 page
- Location: salesplanning-frontend.spec.js:769:9
