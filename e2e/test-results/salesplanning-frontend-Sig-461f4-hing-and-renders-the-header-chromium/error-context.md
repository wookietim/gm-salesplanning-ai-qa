...
- Name: salesplanning-frontend.spec.js >> Signedout page (/signedout) >> loads without crashing and renders the header
- Location: salesplanning-frontend.spec.js:719:5
...
Locator: getByRole('link', { name: 'Sales Planning' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Sales Planning' })
