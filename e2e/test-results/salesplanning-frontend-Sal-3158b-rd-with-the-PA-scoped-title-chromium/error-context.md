...
- Name: salesplanning-frontend.spec.js >> SalesIndexTrend chart >> renders on the PA dashboard with the PA-scoped title
- Location: salesplanning-frontend.spec.js:1075:5
