...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-623 — SalesByWeek legend conditional rendering >> "last year sales" legend item is always visible in all metric modes
- Location: salesplanning-frontend.spec.js:1340:9
