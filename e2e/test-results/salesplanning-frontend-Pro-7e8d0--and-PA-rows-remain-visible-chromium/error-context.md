...
- Name: salesplanning-frontend.spec.js >> ProductAreaSummaryList SegmentControl (metric type switching) >> switches to Sales index metric and PA rows remain visible
- Location: salesplanning-frontend.spec.js:1146:5
...
Call log:
  - waiting for getByLabel('PA list navigation').getByRole('button', { name: 'Sales index' })
