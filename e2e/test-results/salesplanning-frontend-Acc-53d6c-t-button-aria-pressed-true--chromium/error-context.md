...
- Name: salesplanning-frontend.spec.js >> Acceptance criteria from Jira stories >> SSPLAN-691 — Segmented Control on all levels >> Selecting each metric option highlights only that button (aria-pressed=true)
- Location: salesplanning-frontend.spec.js:1310:9
