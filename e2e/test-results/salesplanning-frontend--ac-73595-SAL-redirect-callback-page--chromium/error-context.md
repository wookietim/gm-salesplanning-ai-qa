...
- Name: salesplanning-frontend.spec.js >> /accept_login route (MSAL redirect callback) >> loads without crashing (MSAL redirect callback page)
- Location: salesplanning-frontend.spec.js:988:5
