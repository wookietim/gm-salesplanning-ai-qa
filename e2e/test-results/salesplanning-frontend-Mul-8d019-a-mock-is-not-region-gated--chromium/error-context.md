...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> XX — nonexistent region (valid 2-char code, no real data) >> XX HFB list renders the same mock HFB data (mock is not region-gated)
- Location: salesplanning-frontend.spec.js:1562:9
