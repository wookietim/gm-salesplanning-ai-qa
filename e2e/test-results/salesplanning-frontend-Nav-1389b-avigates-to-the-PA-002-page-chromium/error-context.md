...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> HFB page → PA page (click-based) >> clicking PA 002 (Armchairs) navigates to the PA 002 page
- Location: salesplanning-frontend.spec.js:821:9
