...
- Name: salesplanning-frontend.spec.js >> PlaceholderAvatar / user avatar >> placeholder avatar has aria-label containing the user display name
- Location: salesplanning-frontend.spec.js:1963:5
...
Locator: locator('img[alt="User Avatar"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('img[alt="User Avatar"]')
