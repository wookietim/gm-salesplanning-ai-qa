...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> SE region (/region-dashboard/se/) >> SE HFB dashboard shows SE in breadcrumb
- Location: salesplanning-frontend.spec.js:1514:9
...
Locator: getByLabel('Breadcrumb').getByRole('link', { name: 'SE' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel('Breadcrumb').getByRole('link', { name: 'SE' })
