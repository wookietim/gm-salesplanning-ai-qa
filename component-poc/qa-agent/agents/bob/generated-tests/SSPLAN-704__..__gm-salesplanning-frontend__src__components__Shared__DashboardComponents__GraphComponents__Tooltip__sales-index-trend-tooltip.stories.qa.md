...
- Source component: ../gm-salesplanning-frontend/src/components/Shared/DashboardComponents/GraphComponents/Tooltip/sales-index-trend-tooltip.stories.tsx
...
| --- | --- | --- |
| AC-1 | Issue SSPLAN-704: [FE] Add storybook publishing on each PR | BOB-HP-DEFAUL-001, BOB-HP-DEFAUL-002, BOB-SP-DEFAUL-001, BOB-SP-DEFAUL-002, BOB-A11Y-DEFAUL-001 |
| AC-2 | Acceptance Criteria (derived from description): | BOB-HP-DEFAUL-001, BOB-HP-DEFAUL-002, BOB-SP-DEFAUL-001, BOB-SP-DEFAUL-002, BOB-A11Y-DEFAUL-001 |
| AC-3 | We need a way to see new components implementation and storybook can help with that but we need to have a preview published on each PR open | BOB-HP-DEFAUL-001, BOB-HP-DEFAUL-002, BOB-SP-DEFAUL-001, BOB-SP-DEFAUL-002, BOB-A11Y-DEFAUL-001 |
