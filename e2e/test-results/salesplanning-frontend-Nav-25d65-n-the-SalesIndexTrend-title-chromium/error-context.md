...
- Name: salesplanning-frontend.spec.js >> Navigation path specificity >> Multi-hop journeys >> Each PA page shows only its own data in the SalesIndexTrend title
- Location: salesplanning-frontend.spec.js:951:9
...
Locator: getByText(/Trends - Sales index vs LY - PA 001/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Trends - Sales index vs LY - PA 001/)
