...
- Name: salesplanning-frontend.spec.js >> MetricRowCell numeric values >> PaFamilyListRow shows numeric values alongside metric labels
- Location: salesplanning-frontend.spec.js:1910:5
