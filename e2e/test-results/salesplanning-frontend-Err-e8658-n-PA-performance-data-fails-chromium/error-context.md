...
- Name: salesplanning-frontend.spec.js >> Error states >> PA list shows error message when PA performance data fails
- Location: salesplanning-frontend.spec.js:971:5
...
Locator: getByText('PA performance data is currently unavailable. Please try again later.')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByText('PA performance data is currently unavailable. Please try again later.')
