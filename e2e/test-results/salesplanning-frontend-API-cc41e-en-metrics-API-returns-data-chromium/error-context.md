...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Weekly metrics API data → Sales by week chart >> SalesByWeek section renders on the HFB page when metrics API returns data
- Location: salesplanning-frontend.spec.js:2362:9
