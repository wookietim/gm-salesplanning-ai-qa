...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Hierarchy API data → PA list rows >> PA names from hierarchy response appear as PA row buttons on the HFB page
- Location: salesplanning-frontend.spec.js:2297:9
...
Locator: getByRole('button', { name: /UniquePA001/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /UniquePA001/ })
