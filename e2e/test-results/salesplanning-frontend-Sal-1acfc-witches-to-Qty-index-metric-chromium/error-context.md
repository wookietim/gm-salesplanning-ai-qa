...
- Name: salesplanning-frontend.spec.js >> SalesByWeek SegmentControl (metric type switching) >> switches to Qty index metric
- Location: salesplanning-frontend.spec.js:1123:5
...
Call log:
  - waiting for getByLabel('Sales by week').getByRole('button', { name: 'Qty index' })
