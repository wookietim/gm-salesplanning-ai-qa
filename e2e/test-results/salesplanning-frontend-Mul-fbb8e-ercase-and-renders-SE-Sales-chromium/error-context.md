...
- Name: salesplanning-frontend.spec.js >> Multi-region coverage >> Region URL case-insensitivity >> /region-dashboard/SE/ (uppercase) normalises to lowercase and renders SE Sales
- Location: salesplanning-frontend.spec.js:1588:9
