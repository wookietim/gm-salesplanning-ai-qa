...
- Name: salesplanning-frontend.spec.js >> NewsArticle sub-components >> ChecksRow shows "Has demand plan" label in article rows
- Location: salesplanning-frontend.spec.js:1928:5
