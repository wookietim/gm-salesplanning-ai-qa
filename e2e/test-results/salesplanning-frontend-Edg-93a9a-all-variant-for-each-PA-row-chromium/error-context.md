...
- Name: salesplanning-frontend.spec.js >> Edge cases >> GapToClose component >> PaFamilyListRow shows "Gap:" label (GapToClose small variant) for each PA row
- Location: salesplanning-frontend.spec.js:1668:9
