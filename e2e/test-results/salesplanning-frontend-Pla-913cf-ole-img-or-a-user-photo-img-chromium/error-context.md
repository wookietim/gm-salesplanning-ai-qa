...
- Name: salesplanning-frontend.spec.js >> PlaceholderAvatar / user avatar >> header renders either a placeholder avatar (role=img) or a user photo img
- Location: salesplanning-frontend.spec.js:1953:5
...
Locator: getByRole('button', { name: 'Open user menu' })
Expected: visible
Timeout: 5000ms
