...
- Name: salesplanning-frontend.spec.js >> API data → UI binding >> Hierarchy API data → PA list rows >> PA numbers from hierarchy response appear in PA row buttons
- Location: salesplanning-frontend.spec.js:2304:9
...
Locator: getByRole('button', { name: /UniquePA001.*001/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /UniquePA001.*001/ })
